...
const FacilitesGroupAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "/roomfacility/roomFacilityGroupSave",
        formData,
        {
          headers: {
  ...
  return (
    <>
      <Helmet>
        <title>Add Facilites Group</title>
      </Helmet>
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Add Facilites Group</div>
                <div className="ps-3">
...
export default FacilitesGroupAdd;
