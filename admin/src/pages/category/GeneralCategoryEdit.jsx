...
const GeneralCategoryEdit = () => {
  ...
  const defaultFetch = async () => {
    try {
      const response = await axios.get(`/category/checkGeneralCategory`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        params: { categoryId: id },  // or simply { userId } using shorthand
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/category/GeneralCategorySave", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      navigate("/category/global-category-list");
    } catch (error) {
  ...
  const handleAddNewClick = () => {
    navigate('/category/general-category-list');
  };
  ...
  return (
    <>
      <Helmet>
        <title>Edit General Category</title>
      </Helmet>
