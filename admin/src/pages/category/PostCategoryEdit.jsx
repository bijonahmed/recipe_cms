...
const PostCategoryEdit = () => {
  ...
  const defaultFetch = async () => {
    try {
      const response = await axios.get(`/category/checkPostCategory`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/category/postCategorySave", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      navigate("/category/post-category-list");
    } catch (error) {
