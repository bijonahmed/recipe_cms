...
const BookingTypeList = () => {
  ...
  const apiUrl = "/roomsetting/bookingTypeList";
  const handleSort = () => {
  ...
  const handleAddNewClick = () => {
    navigate("/roomsetting/add-booking-type");
  };

  const handleEdit = (id) => {
    navigate(`/roomsetting/booking-type-edit/${id}`);
  };
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Booking Type List</div>
                <div className="ps-3">
