...
const RoomSizeList = () => {
  ...
  const apiUrl = "/roomsetting/roomSizeList";
  const handleSort = () => {
  ...
  const handleAddNewClick = () => {
    navigate("/roomsetting/add-room-size");
  };

  const handleEdit = (id) => {
    navigate(`/roomsetting/room-size-edit/${id}`);
  };
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Room Size List</div>
                <div className="ps-3">
