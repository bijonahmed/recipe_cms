...
const BedTypeList = () => {
  ...
  const apiUrl = "/roomsetting/bedtypelist";
  const handleSort = () => {
  ...
  const handleAddNewClick = () => {
    navigate("/roomsetting/add-bed-type");
  };

  const handleEdit = (id) => {
    navigate(`/roomsetting/bed-type-edit/${id}`);
  };
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Bed Type List</div>
                <div className="ps-3">
