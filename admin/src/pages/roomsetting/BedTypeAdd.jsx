...
const BedTypeAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/roomsetting/bedtypeSave", formData, {
        headers: {
      ...
      navigate("/roomsetting/bed-type-list");
    } catch (error) {
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Add Bed Type</div>
                <div className="ps-3">
                ...
                <div className="card-body p-4">
                  <form onSubmit={handleSubmit}>
                    <div className="row mb-3">
                      <label htmlFor="input42" className="col-sm-3 col-form-label">Name <span className="text-danger">*</span> </label>
                    ...
                    <div className="row mb-3">
                      <label htmlFor="input46" className="col-sm-3 col-form-label">Status <span className="text-danger">*</span> </label>
                      <div className="col-sm-9">
                        <select
