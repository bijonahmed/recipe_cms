...
const BookingTypeEdit = () => {
  ...
  const defaultFetch = async () => {
    try {
      const response = await axios.get(`/roomsetting/checkBookingTypeRow`, {
        headers: {
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Edit Booking Type</div>
                <div className="ps-3">
