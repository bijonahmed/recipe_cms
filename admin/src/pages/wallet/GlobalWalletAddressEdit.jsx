...
const GlobalWalletAddressEdit = () => {
  ...
  const defaultFetch = async () => {
    try {
      const response = await axios.get(`/wallet/checkWalletInfo`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        params: { walletId: id }, // or simply { userId } using shorthand
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/wallet/save", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Wallet</div>
                <div className="ps-3">
...
export default GlobalWalletAddressEdit;
