...
const GlobalWalletAddressList = () => {
  ...
  const apiUrl = "/wallet/globalWalletAddressList";
  ...
  const handleAddNewClick = () => {
    navigate("/wallet/global-wallet-address-add");
  };

  const handleEdit = (id) => {
    navigate(`/wallet/global-wallet-edit/${id}`);
  };
          ...
          <div className="page-wrapper">
            <div className="page-content">
              <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div className="breadcrumb-title pe-3">Global TronScan Wallet Address</div>
                <div className="ps-3">
...
export default GlobalWalletAddressList;
